...
app = FastAPI(
    title="Fase 0A - api",
    description=(
        "Servico do experimento da Fase 0A. Sem dominio publico: alcancado "
        "apenas pelo servico `web`, por rede privada."
    ),
    version="0.1.0",
    lifespan=lifespan,
    # Sem docs interativos: a superficie e consumida pelo proxy do `web`,
